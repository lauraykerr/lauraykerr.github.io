...
var stopList = ["and", "to", "the", "of", "that", "in", "have", "for", "it", "this", "is", "not", "with", "was", "be", "all", "on", "am", "ve", "about", "what", "as", "at", "from", "or", "do", "an", "are", "had", "by", "has", "so", "can", "were", "those", "re", "any", "which", "out", "than", "did", "then", "don", "also", "through", "into", "thing", "whom", "put", "while"];
